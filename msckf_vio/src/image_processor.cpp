...
bool ImageProcessor::createRosIO() {
  ...
  //cam0_img_sub.connectInput(cam0_img_sub);
...
void ImageProcessor::trackFeatures() {
  ...
  //removeUnmarkedElements(
     // prev_tracked_cam1_points, track_inliers, prev_matched_cam1_points);
  //removeUnmarkedElements(
     // curr_tracked_cam0_points, match_inliers, curr_matched_cam0_points);
  
  //removeUnmarkedElements(
     // curr_cam1_points, track_inliers, curr_matched_cam1_points);

  // Number of features left after stereo matching.
  after_matching = curr_tracked_cam0_points.size();//curr_matched_cam0_points.size();
